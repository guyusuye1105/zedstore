...
use app\common\model\Logrecord as LogrecordModel;
...
class WxPay
{
    ...
    public function unifiedorder($order_no, $openid, $total_fee)
    {
        ...
        $params = [
            ...
            'notify_url' => rtrim(str_replace('index.php','notice.php',base_url()),'/') ,  // 异步通知地址
            'openid' => $openid,
       ...
       // p($params);
        /*
            [appid] => wx1040f29af7bae4b3
            [attach] => test
            [body] => 2019013049999850
            [mch_id] => 1510051671
            [nonce_str] => a7a4888438d5213a98ca97e0013000bc
            [notify_url] => http://localhost:9001/addons/mt2_mshop/web
            [openid] => o8ovE5G_nyCmdEemL8gU5QETs5U0
            [out_trade_no] => 2019013049999850
            [spbill_create_ip] => 0.0.0.0
            [total_fee] => 11100
            [trade_type] => JSAPI
            [sign] => 4C4276FE397026A3F354591B050A2B09
         */
    ...
    {
//        $xml = <<<EOF
//<xml><appid><![CDATA[wx1040f29af7bae4b3]]></appid>
//<attach><![CDATA[test]]></attach>
//<bank_type><![CDATA[ICBC_DEBIT]]></bank_type>
//<cash_fee><![CDATA[1]]></cash_fee>
//<fee_type><![CDATA[CNY]]></fee_type>
//<is_subscribe><![CDATA[N]]></is_subscribe>
//<mch_id><![CDATA[1510051671]]></mch_id>
//<nonce_str><![CDATA[98a83fb16336bfec28fc53ff8237a34e]]></nonce_str>
//<openid><![CDATA[o8ovE5G_nyCmdEemL8gU5QETs5U0]]></openid>
//<out_trade_no><![CDATA[2019013057535556]]></out_trade_no>
//<result_code><![CDATA[SUCCESS]]></result_code>
//<return_code><![CDATA[SUCCESS]]></return_code>
//<sign><![CDATA[1F7A1D0A938EA7D0C2050C1254701761]]></sign>
...
//EOF;
        if (!$xml = file_get_contents('php://input')) {
            ...
            $logRecordModel->insertLog($data3);
        ...
        $order = $OrderModel->payDetail($data['out_trade_no']);// 获取待支付订单详情
        ...
        if (($sign === $dataSign)
            ...
            $id = $order['id'];
            $order = $OrderModel->getDataById($id);
            $data2['state'] = 'complete';
            $data2['wxapp_id'] = $order['wxapp_id'];
            $OrderModel->updateDataById($data2,$id);
            // 发送短信通知
