    ...
    <div id="wrapper" class="login-body">
        <div class="login-content">
            <div class="brand">
                ...
                --><img alt="logo" class="brand-img" src="assets/store/img/login_logo.png">
                <h2 class="brand-text">同城技能服务商城</h2>
            </div>
            <form id="login-form" class="login-form">
                ...
                <div class="form-group">
                    <button id="btn-submit" type="submit" style="background-color: #6274e6">
                        登录
                    </button>
                </div>
            </form>
