                    ...
                    <div class="widget-body">
                        <fieldset>
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">修改员工信息</div>
                            </div>
                            <input type="hidden" name="staff[id]" value="<?=$list[0]['id']?>">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <select name="staff[job_id]" required
                                        ...
                                        <?php if (isset($data['job'])): foreach ($data['job'] as $pval): ?>
                                            <option value="<?= $pval['id'] ?>"  <?php if($pval['id'] == $list[0]['job_id']):?> selected <?php endif;?>>
                                                　　<?= $pval['name'] ?></option>
                                        ...
                                        <div class="am-form-file">
                                            ...
                                            <div class="uploader-list am-cf">
                                                    ...
                                                    <div class="file-item">
                                                        ...
                                                        <input type="hidden" name="staff[images][]"
                                                               value="<?= $list[0]['cover'] ?>">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="staff[vacation_time]"
                                           value="<?=$list[0]['vacation_time']?>" required>
                                </div>
                            </div>
                            <div class="am-form-group">
