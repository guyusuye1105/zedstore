                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    省:<select type="text" id="province" class="tpl-form-input addrselect" name="store[province]"
                                              value="<?=$list[0]['province']?>" required>
                                    </select>
                                    市:<select type="text" id="city" class="tpl-form-input addrselect" name="store[city]"
                                              value="<?=$list[0]['city']?>" required></select>
                                    区:<input type="text" id="county" class="tpl-form-input addrselect" name="store[county]"
...
<script type="text/javascript">
    $(function () {
        ...
        str += ("_" + (document.getElementById('province').selectedIndex - 1));
        if (dsy.Exists(str)) {
            ar = dsy.Items[str];
            for (var i = 0; i < ar.length; i++) {
                options.add(new Option(ar[i], ar[i]));
            }
        }
        var aaa = '<?php echo $list[0]['city']; ?>';
        $('#city').find('option[value='+aaa+']').attr("selected",true)
    })
</script>
